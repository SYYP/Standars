...
public class ElectricityCountActivity extends BaseActivity implements View.OnClickListener,HttpLoader.ResponseListener{
    ...
    private EditText ed_electricity_unit;
    private EditText ed_electricity_goujian;
    private EditText ed_electricity_yibiao;
    private EditText ed_electricity_type;
    private EditText ed_electricity_strattime;
    ...
    protected void initView() {
        ...
        ed_electricity_unit = findViewById(R.id.ed_electricity_unit);
        ed_electricity_goujian = findViewById(R.id.ed_electricity_goujian);
        ed_electricity_yibiao = findViewById(R.id.ed_electricity_yibiao);
        ed_electricity_type = findViewById(R.id.ed_electricity_type);
        ed_electricity_name = findViewById(R.id.ed_electricity_name);
        ...
        ed_electricity_type.setOnClickListener(this);
        ed_electricity_strattime.setOnClickListener(this);
        ed_electricity_endtime.setOnClickListener(this);
        electricity_data_btn.setOnClickListener(this);
        ed_electricity_name.setOnClickListener(this);
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.button_fan:
                finish();
                break;
            case R.id.ed_electricity_unit:
                /**单位*/
                minitListView5=initListView5();
                PopupWindowUtils.showPopupWindow( minitListView5,ed_electricity_unit);
                break;
            case R.id.ed_electricity_goujian:
                /**构筑物*/
                String s=ed_electricity_goujian.getText().toString();
                if("".equals(s)||"null".equals(s)||s==null){
                    Toast.makeText(ElectricityCountActivity.this, "请选择单位", Toast.LENGTH_SHORT).show();
                    return;
                }
                minitListView6=initListView6();
                PopupWindowUtils.showPopupWindow( minitListView6,ed_electricity_goujian);
                break;
            case R.id.ed_electricity_yibiao:
                /**指标*/
                String s2=ed_electricity_yibiao.getText().toString();
                if("".equals(s2)||"null".equals(s2)||s2==null){
                    Toast.makeText(ElectricityCountActivity.this, "请选择单位", Toast.LENGTH_SHORT).show();
                    return;
                }
                String  s3=ed_electricity_yibiao.getText().toString();
                if("".equals(s3)||"null".equals(s3)||s3==null){
                    Toast.makeText(ElectricityCountActivity.this, "请选择构筑物", Toast.LENGTH_SHORT).show();
                    return;
                }
                minitListView7=initListView7();
                PopupWindowUtils.showPopupWindow( minitListView7,ed_electricity_yibiao);
                break;
            case R.id.ed_electricity_strattime:
                /**开始时间*/
                dialog.show(ed_electricity_strattime);
                dialog.showTime();
                break;
            case R.id.ed_electricity_endtime:
                /**结束时间*/
                dialog.show(ed_electricity_endtime);
                dialog.showTime();
                break;
            case R.id.ed_electricity_type:
                minitListView3= plu.initListView9();
                PopupWindowUtils.showPopupWindow(minitListView3, ed_electricity_type);
                minitListView3.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    @Override
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        ed_electricity_type.setText(plu.mListView9.get(position));
                        if("精细查询".equals( ed_electricity_type.getText().toString())){
...
//                });
                break;
            case R.id.ed_electricity_name:
                minitListView2= plu.initListView8();
                PopupWindowUtils.showPopupWindow(minitListView2, ed_electricity_name);
                minitListView2.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    @Override
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        ed_electricity_name.setText(plu.mListView8.get(position));
                        if("精细查询".equals( ed_electricity_name.getText().toString())){
//                            image_shunshi.setVisibility(View.GONE);
//                            ed_shunshi.setVisibility(View.GONE);
                        }else{
//                            image_shunshi.setVisibility(View.VISIBLE);
//                            ed_shunshi.setVisibility(View.VISIBLE);
            ...
            case R.id.run_data_btn:
                ...
                String dw=ed_electricity_unit.getText().toString();
                if("".equals(dw)||dw==null||"null".equals(dw)){
                    Toast.makeText(ElectricityCountActivity.this, "请选择单位", Toast.LENGTH_SHORT).show();
                    return;
                }
                String gzw=ed_electricity_goujian.getText().toString();
                if("".equals(gzw)||gzw==null||"null".equals(gzw)){
                    Toast.makeText(ElectricityCountActivity.this, "请选择构筑物", Toast.LENGTH_SHORT).show();
                    return;
                }
                String sb=ed_electricity_yibiao.getText().toString();
                if("".equals(sb)||sb==null||"null".equals(sb)){
                    Toast.makeText(ElectricityCountActivity.this, "请选择设备", Toast.LENGTH_SHORT).show();
                    return;
                }
                String start=ed_electricity_strattime.getText().toString();
                String end=ed_electricity_endtime.getText().toString();
                if("".equals(start)||start==null||"null".equals(start)){
                    Toast.makeText(ElectricityCountActivity.this, "请选择开始时间", Toast.LENGTH_SHORT).show();
                    return;
                }
                String xiao=ed_electricity_type.getText().toString();
                if("".equals(xiao)||xiao==null||"null".equals(xiao)){
                    Toast.makeText(ElectricityCountActivity.this, "请选择查询模式", Toast.LENGTH_SHORT).show();
                    return;
                }
                String shun=ed_electricity_type.getText().toString();
                /**发起网络请求*/
                showProgressDialog();
    ...
    public void onGetResponseSuccess(int requestCode, RBResponse response) {
        if (requestCode == ConstantsYunZhiShui.REQUEST_CODE_ZXJCBUSINESS
            ...
            if ("00000".equals( mBusinessUnit.getErrorCode())) {
                ...
                minitListView5.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    @Override
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        ed_electricity_unit.setText(mBusinessUnit.getData().getComboboxList().get(position).getText());
        ...
        if (requestCode == ConstantsYunZhiShui.REQUEST_CODE_ZXJCBUILDING
            ...
            if ("00000".equals(mBuilding.getErrorCode())) {
                ...
                minitListView6.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    @Override
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        ed_electricity_goujian.setText(mBuilding.getData().getComboboxList().get(position).getText());
        ...
        if (requestCode == ConstantsYunZhiShui.REQUEST_CODE_ZXJCQUOTA
            ...
            if ("00000".equals(mQuota.getErrorCode())) {
                ...
                minitListView7.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    @Override
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        ed_electricity_yibiao.setText( mQuota.getData().getComboboxList().get(position).getText());
        ...
        if (requestCode == ConstantsYunZhiShui.REQUEST_CODE_ZXJCRUNDATA
            ...
            if("00000".equals(mRunData.getErrorCode())){
                ...
                Intent intent=new Intent(ElectricityCountActivity.this,RunDataReslutActivity.class);
    ...
    class MyBusinesAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                convertView = View.inflate(ElectricityCountActivity.this, R.layout.item_search, null);
